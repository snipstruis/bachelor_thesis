...
uSince MC allows polymorphic types, one indentifier may be defined multiple times: once for each type.
...
The rules are the function definitions of MC and functions can have multiple of them.
