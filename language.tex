...
The F\# code model mainly involved switching off indentation-based scoping for F\# and using the verbose syntax.
...
\item It perform monadic operations for each rule attempt.
